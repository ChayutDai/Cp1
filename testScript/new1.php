...
// [ String Dialog XML]
{
	...
	$infoDialog = '<FieldLayout visible="true" field="'.$result["COLUMN_NAME"].'" displayName="'.$result["COLUMN_NAME"].'" fieldGuid="e053017e-21ba-479d-9503-4556a62e35ad" allowEdit="true" columnNumber="13" maskGuid="00000000-0000-0000-0000-000000000000" allowFiltering="true" selectListOnly="false">
              <Label letters="standard" label="'.$result["COLUMN_NAME"].'" />
              <FieldCell textWrap="false" />
              <SelectLists totalNumber="0" allowInternalSelectList="true">
              </SelectLists>
		  ...
		  $ifDialog = $listDialog.$infoDialog;
