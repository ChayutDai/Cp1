...
// [ String Dialog XML]
	...
	$infoDialog = '<FieldLayout visible="true" field="'.$result["COLUMN_NAME"].'" displayName="'.$result["COLUMN_NAME"].'" fieldGuid="e053017e-21ba-479d-9503-4556a62e35ad" allowEdit="true" columnNumber="'.$countDialog.'" maskGuid="00000000-0000-0000-0000-000000000000" allowFiltering="true" selectListOnly="false">
      ...
      <FixedEntry>No</FixedEntry>
			  ...
			  $searchDialogfilename = '<SearchDialogField name="FILE_NAME" displayName="FILE_NAME" visible="true" orderNumber="'.$countDialog.'" guid="e053017e-21ba-479d-9503-4556a62e35ad" allowFiltering="true">
            <FieldEntry allowExtendedSearch="false">
              <AddWildcards>false</AddWildcards>
              <FixedText lock="false" enabled="false" isFixedEntry="true" predefinedEntry="EMPTY" type="Both">
              </FixedText>
		 ...
		 // ++$countDialog;
		      $storeDialogfilename = '<StoreDialogField name="FILE_NAME" displayName="FILE_NAME" visible="true" orderNumber="'.$countDialog.'" guid="e053017e-21ba-479d-9503-4556a62e35ad" allowFiltering="true" selectListOnly="false">
            <FieldEntry allowExtendedSearch="false">
              <AddWildcards>false</AddWildcards>
              <FixedText lock="false" enabled="false" isFixedEntry="true" predefinedEntry="EMPTY" type="Both">
              </FixedText>
		      ...
		      $lvDialogfilename = '<FieldLayout visible="true" field="FILE_NAME" displayName="File_Name" fieldGuid="e053017e-21ba-479d-9503-4556a62e35ad" columnNumber="'.$countDialog.'">
              <Label letters="standard" label="FILE_NAME" />
              <FieldCell textWrap="false" />
            </FieldLayout>';
			  $ifDialogfilename = '<FieldLayout visible="true" field="FILE_NAME" displayName="File_Name" fieldGuid="e053017e-21ba-479d-9503-4556a62e35ad" allowEdit="true" columnNumber="'.$countDialog.'" maskGuid="00000000-0000-0000-0000-000000000000" allowFiltering="true" selectListOnly="false">
              <Label letters="standard" label="FILE_NAME" />
              <FieldCell textWrap="false" />
              <SelectLists totalNumber="0" allowInternalSelectList="true">
              </SelectLists>
...
$wordFcProfile = $wordFcProfile.',FILE_NAME,';	
// [ String FCprofile ]
...
// HDialog + shdialog + sDialog + searchDialogfilename + sfdialog +/ sthdialog + stdialog + stfdialog + reshdialog + lvhDialog +lvDialog + lvDialogfilename+ lvfDialog 
// +ifhDialog + infoDialog + ifDialogfilename + iffDialog + resfdialog// +  FDialog			
			  $finish = $HCabinet.$general.$database.$headField.$word.$filename.$footField.$HfcProfile.$FCPRFILE.$FfcProfile.$HDialog.$shdialog.$sDialog.$searchDialogfilename.$sfdialog.$sthdialog.$stDialog.$storeDialogfilename.$stfdialog.$reshdialog.$lvhDialog.$listDialog.$lvDialogfilename.$lvfDialog.$ifhDialog.$ifDialog.$ifDialogfilename.$iffDialog.$resfdialog.$FCabinet;
